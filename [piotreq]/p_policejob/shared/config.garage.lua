...
Config.Garage.Garages = {
    ['Mission_Row'] = {
        ...
        spawnPoints = {
            vector4(438.30, -988.70, 25.70, 81.96),
            vector4(437.68, -986.18, 25.70, 88.83),
            vector4(437.49, -991.54, 25.70, 85.82),
            vector4(437.93, -994.36, 25.70, 85.57),
            vector4(438.01, -996.78, 25.70, 85.88)
        }
    }
}