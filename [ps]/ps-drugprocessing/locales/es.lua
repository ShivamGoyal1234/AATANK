local Translations = {
    error = {
        ...
        no_weedplant_branch = "Te estás perdiendo el weedplant_branch",
    ...
    success = {
        ...
        weedplant_branch = "weedplant_branch recolectado con éxito",
        weedplant_packedweed = "Marihuana producida con éxito",
