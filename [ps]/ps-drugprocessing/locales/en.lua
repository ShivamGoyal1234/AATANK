local Translations = {
    error = {
        ...
        no_weedplant_branch = "You are missing weedplant_branch!",
        no_marijuhana = "You are missing weedplant_packedweed!",
    ...
    success = {
        ...
        weedplant_branch = "Successfully collected weedplant_branch!",
        weedplant_packedweed = "Successfully produced weedplant_packedweed!",
    ...
    target = {
        ...
        pickWeed = "Collect weedplant_branch",
