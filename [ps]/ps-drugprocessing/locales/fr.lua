local Translations = {
    error = {
        ...
        no_weedplant_branch = "Il te manque du weedplant_branch !",
        no_marijuhana = "Il te manque de la weedplant_packedweed !",
    ...
    success = {
        ...
        weedplant_branch = "weedplant_branch récolté avec succès !",
        weedplant_packedweed = "weedplant_packedweed produite avec succès !",
    ...
    target = {
        ...
        pickWeed = "Collecte de weedplant_branch",
