...
--==========================================================
Commands.openDoor = function(door)
    local Ped     = PlayerPedId()
    local vehicle = nil
    local doornum = tonumber(door) + 1
    if doornum < 1 or doornum > 6 then
...
RegisterNetEvent(getScript()..":client:openDoor", function(door) Commands.openDoor(door) end)
