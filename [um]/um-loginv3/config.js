const UM = {
    ...
    BackgroundSettings: {
        ...
        videoBackground: {
            ...
            youtubeVID: {
                enabled: true,
                link: "cqalcaxEcCM", //? only youtube video id || example: https://www.youtube.com/watch?v=Awgpquzwwz0 | id = Awgpquzwwz0
    ...
    // ? Cards
    Store: {
        title: 'Aatank RolePlay',
        description: 'A Immersive RP experience!',
        button: 'Happy RPing',
    ...
    ChangeLog: {
        title: 'CHANGELOG',
        description: 'Something new comes here!',
        button: 'VIEW CHANGELOG',
        character_image: 'assets/images/characters/char-man.png',
        page: {
            content: [
               "Advance Police System",
               "Advance Mechanic",
               "12+ Jobs Available",
            //    "[ 🍕 ] Something new",
             ],
